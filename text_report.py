...
def get_text_data_report():
    ...
    try:
        ...
        query = "SELECT date_and_time, source_text, source_language, target_language, translated_text, user_text_trans_log.user, vendor, billed_characters,  refinement_used, domain_name AS opco FROM public.user_text_trans_log"
